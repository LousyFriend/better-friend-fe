      ...
      <Link to={`/details/${id}`} style={{ margin: '30px' }}>
        {
          <div class='w-auto bg-white rounded-lg shadow-xl flex flex-col md:flex-row lg:justify-center min-h-full md:text-2xl sm:h-full p-6'>
            <div class='w-auto md:w-1/2 align-left p-4 flex-1 md:p-10 m-0 grid grid-cols-1 h-auto justify-start relative'>
              {
                image_url === null || image_url === undefined || image_url === ''
                  ...
                  : <img class='object-center rounded-lg object-cover w-40 h-80% absolute left-2 top-2' src={ image_url } alt='blank avatar'></img>
              }
            
              <div class='p-20 justify-center '>
                <section class='flex flex-col p-4 absolute right-8 w-1/2 bottom-8 lg:top-6 lg:text-2xl lg:right-0 xl:text-xl'>
                  <div class=''>{ name }</div>
